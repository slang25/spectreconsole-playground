...
class W {
  ...
  encode(A) {
    ...
    if (this.exports.ghostty_wasm_free_opaque(Q), this.exports.ghostty_key_event_set_action(C, A.action), this.exports.ghostty_key_event_set_key(C, A.key), this.exports.ghostty_key_event_set_mods(C, A.mods), A.utf8) {
      const k = new TextEncoder().encode(A.utf8), e = this.exports.ghostty_wasm_alloc_u8_array(k.length);
      new Uint8Array(this.exports.memory.buffer).set(k, e), this.exports.ghostty_key_event_set_utf8(C, e, k.length), this.exports.ghostty_wasm_free_u8_array(e, k.length);
    }
...
const v = {
  ...
  sendMouseEvent(A, Q, B, E, C) {
    ...
    let o;
    if (D)
      o = this.encodeMouseSGR(A, Q, B, E, I);
    else {
      const t = E ? 3 : A;
      o = this.encodeMouseX10(t, Q, B, I);
    }
  ...
  handleMouseMove(A) {
    ...
    if (this.isDisposed || !((I = this.mouseConfig) != null && I.hasMouseTracking()))
      return;
    const Q = ((D = this.getModeCallback) == null ? void 0 : D.call(this, 1002)) ?? !1, B = ((o = this.getModeCallback) == null ? void 0 : o.call(this, 1003)) ?? !1;
    ...
    for (let I = 0; I < C.length; I++) {
      ...
      if (t) {
        ...
        for (let e = I + 1; e < C.length; e++) {
          const a = C.getCell(e);
          if (!a || a.getHyperlinkId() === 0 || this.terminal.wasmTerm.getHyperlinkUri(s, e) !== t)
            break;
          M = e;
        }
        for (let e = I; e <= M; e++)
        ...
        B.push({
          ...
          range: k,
          activate: (e) => {
            (e.ctrlKey || e.metaKey) && window.open(t, "_blank", "noopener,noreferrer");
          }
        });
      }
    }
...
const d = class L {
  ...
  provideLinks(A, Q) {
    ...
    for (; I !== null; ) {
      ...
      s.length < D.length && (D = s, w = o + D.length - 1), D.length > 8 && B.push({
        text: D,
        range: {
          start: { x: o, y: A },
          end: { x: w, y: A }
...
class QA {
  ...
  measureFont() {
    ...
    const B = Q.measureText("M"), E = Math.ceil(B.width), C = B.fontBoundingBoxAscent ?? B.actualBoundingBoxAscent ?? this.fontSize * 0.8, I = B.fontBoundingBoxDescent ?? B.actualBoundingBoxDescent ?? this.fontSize * 0.2, D = Math.ceil(C + I), o = Math.ceil(C);
  ...
  render(A, Q = !1, B = 0, E, C = 1) {
    ...
    const o = A.getCursor(), w = A.getDimensions(), s = E ? E.getScrollbackLength() : 0;
    (U = A.needsFullRedraw) != null && U.call(A) && (Q = !0), (this.canvas.width !== w.cols * this.metrics.width * this.devicePixelRatio || this.canvas.height !== w.rows * this.metrics.height * this.devicePixelRatio) && (this.resize(w.cols, w.rows), Q = !0), I !== this.lastViewportY && (Q = !0, this.lastViewportY = I);
    const M = o.x !== this.lastCursorPosition.x || o.y !== this.lastCursorPosition.y;
    if (M || this.cursorBlink) {
      if (!Q && !A.isRowDirty(o.y)) {
        const h = A.getLine(o.y);
        h && this.renderLine(h, o.y, w.cols);
      }
      if (M && this.lastCursorPosition.y !== o.y && !Q && !A.isRowDirty(this.lastCursorPosition.y)) {
        const h = A.getLine(this.lastCursorPosition.y);
        h && this.renderLine(h, this.lastCursorPosition.y, w.cols);
      }
    }
    const k = D || this.selectionManager && this.selectionManager.hasSelection(), e = /* @__PURE__ */ new Set();
    if (D ? this.currentSelectionCoords = {
      startCol: D.start.x,
      startRow: D.start.y,
      endCol: D.end.x,
      endRow: D.end.y
    } : this.currentSelectionCoords = k ? this.selectionManager.getSelectionCoords() : null, this.currentSelectionCoords) {
    ...
    const a = /* @__PURE__ */ new Set(), c = this.hoveredHyperlinkId !== this.previousHoveredHyperlinkId, J = JSON.stringify(this.hoveredLinkRange) !== JSON.stringify(this.previousHoveredLinkRange);
    if (c) {
      for (let h = 0; h < w.rows; h++) {
        let G = null;
        if (I > 0)
          if (h < I && E) {
            const r = s - Math.floor(I) + h;
            G = E.getScrollbackLine(r);
          } else {
            const r = h - Math.floor(I);
            G = A.getLine(r);
          }
        else
          G = A.getLine(h);
        if (G) {
          for (const r of G)
            if (r.hyperlink_id === this.hoveredHyperlinkId || r.hyperlink_id === this.previousHoveredHyperlinkId) {
              a.add(h);
              break;
            }
        }
    ...
    for (let h = 0; h < w.rows; h++)
      (I > 0 ? !0 : Q || A.isRowDirty(h) || e.has(h) || a.has(h)) && (N.add(h), h > 0 && N.add(h - 1), h < w.rows - 1 && N.add(h + 1));
    for (let h = 0; h < w.rows; h++) {
      if (!N.has(h))
        continue;
      let G = null;
      if (I > 0)
        if (h < I && E) {
          ...
          const r = I > 0 ? h - Math.floor(I) : h;
          G = A.getLine(r);
        }
      else
        G = A.getLine(h);
      G && this.renderLine(G, h, w.cols);
    }
    if (I === 0 && o.visible && this.cursorVisible) {
      const h = o.style ?? this.cursorStyle;
      this.renderCursor(o.x, o.y, h);
    }
    E && C > 0 && this.renderScrollbar(I, s, w.rows, C), this.lastCursorPosition = { x: o.x, y: o.y }, A.clearDirty();
  }
  /**
  ...
  renderCellBackground(A, Q, B) {
    ...
    A.flags & F.INVERSE && (o = A.fg_r, w = A.fg_g, s = A.fg_b), o === 0 && w === 0 && s === 0 || (this.ctx.fillStyle = this.rgbToCSS(o, w, s), this.ctx.fillRect(E, C, I, this.metrics.height)), D && this.theme.selectionBackground && (this.ctx.globalAlpha = 0.4, this.ctx.fillStyle = this.theme.selectionBackground, this.ctx.fillRect(E, C, I, this.metrics.height), this.ctx.globalAlpha = 1);
  }
  /**
  ...
  renderCellText(A, Q, B, E) {
    ...
    const k = C, e = I + this.metrics.baseline;
    let a;
    A.grapheme_len > 0 && ((J = this.currentBuffer) != null && J.getGraphemeString) ? a = this.currentBuffer.getGraphemeString(B, Q) : a = String.fromCodePoint(A.codepoint || 32);
    const c = A.codepoint || 32;
    if (this.renderBlockChar(c, C, I, D) || this.renderPowerlineGlyph(c, C, I, D) || this.ctx.fillText(a, k, e), A.flags & F.FAINT && (this.ctx.globalAlpha = 1), A.flags & F.UNDERLINE) {
  ...
  renderCursor(A, Q, B) {
    ...
    switch (this.ctx.fillStyle = this.theme.cursor, I) {
      case "block":
        ...
        const o = (D = this.currentBuffer) == null ? void 0 : D.getLine(Q);
        o != null && o[A] && this.renderCellText(o[A], A, Q, this.theme.cursorAccent);
        break;
      case "underline":
        ...
        break;
      case "bar":
        const s = Math.max(2, Math.floor(this.metrics.width * 0.15));
        this.ctx.fillRect(E, C, s, this.metrics.height);
        break;
    }
  }
  // ==========================================================================
  ...
  renderScrollbar(A, Q, B, E = 1) {
    ...
    const J = A > 0 ? 0.5 : 0.3;
    C.fillStyle = `rgba(128, 128, 128, ${J * E})`, C.fillRect(w, a, o, k);
  }
  getMetrics() {
    return { ...this.metrics };
  }
    ...
    for (let D = Q; D <= E; D++) {
      ...
      for (let k = s; k <= t; k++) {
        ...
        if (e && e.codepoint !== 0) {
          ...
          if (e.grapheme_len > 0)
            if (D < C)
              a = this.wasmTerm.getScrollbackGraphemeString(D, k);
            else {
              const c = D - C;
              a = this.wasmTerm.getGraphemeString(c, k);
            }
          else
            a = String.fromCodePoint(e.codepoint);
          M += a, a.trim() && (w = M.length);
        } else
          (!e || e.width !== 0) && (M += " ");
      }
...
`);
  ...
  attachEventListeners() {
    ...
    A.addEventListener("mousedown", (Q) => {
      ...
      if (B !== null && this.mouseButtonsPressed.has(B) && this.terminal.hasMouseTracking()) {
        const E = A.getBoundingClientRect(), C = Math.max(0, Math.min(Q.clientX - E.left, E.width)), I = Math.max(0, Math.min(Q.clientY - E.top, E.height)), D = this.pixelToCell(C, I), o = this.encodeModifiers(Q);
        this.sendMouseEvent(D.col, D.row, B, !0, o), this.mouseButtonsPressed.delete(B);
        return;
      }
  ...
  normalizeSelection() {
    ...
    return I < 0 || C > o ? null : (C < 0 && (C = 0, A = 0), I > o && (I = o, B = D.cols - 1), { startCol: A, startRow: C, endCol: B, endRow: I });
  }
  /**
  ...
  constructor(A = {}) {
    this.unicode = {
      ...
      if (!this.canvas || !this.renderer || !this.linkDetector || !this.wasmTerm)
        return;
      const E = this.canvas.getBoundingClientRect(), C = Math.floor((B.clientX - E.left) / this.renderer.charWidth), D = Math.floor((B.clientY - E.top) / this.renderer.charHeight), o = this.wasmTerm.getScrollbackLength();
      let w;
      ...
      if (M) {
        let k = !1;
        this.linkClickHandler && (k = this.linkClickHandler(M.text, B)), k || M.activate(B), (B.ctrlKey || B.metaKey) && B.preventDefault();
      }
    }, this.handleWheel = (B) => {
      var I, D, o, w;
      ...
      if (this.hasMouseTracking() && E && this.canvas && this.renderer) {
        const s = this.canvas.getBoundingClientRect(), t = B.clientX - s.left, M = B.clientY - s.top, k = this.renderer.getMetrics(), e = Math.max(0, Math.min(Math.floor(t / k.width), this.cols - 1)), a = Math.max(0, Math.min(Math.floor(M / k.height), this.rows - 1));
        let c = 0;
        ...
        for (let h = 0; h < J; h++)
          this.dataEmitter.fire(`\x1B[<${U};${e + 1};${a + 1}M`);
        return;
      }
      if (((D = this.wasmTerm) == null ? void 0 : D.isAlternateScreen()) ?? !1) {
        ...
        if (B.deltaMode === WheelEvent.DOM_DELTA_PIXEL) {
          ...
          B.deltaMode === WheelEvent.DOM_DELTA_LINE ? s = B.deltaY : B.deltaMode === WheelEvent.DOM_DELTA_PAGE ? s = B.deltaY * this.rows : s = B.deltaY / 33;
        if (s !== 0) {
      ...
      if (I >= t && I <= t + s) {
        ...
        const k = w - M * 2, e = this.rows, a = E + e, c = Math.max(20, e / a * k), J = this.viewportY / E, N = M + (k - c) * (1 - J);
        if (D >= N && D <= N + c)
          ...
          const h = 1 - (D - M) / k, G = Math.round(h * E);
    ...
    }, this.ghostty = A.ghostty ?? oA(), this.linkClickHandler = A.onLinkClick;
    const Q = {
      cols: A.cols ?? 80,
      rows: A.rows ?? 24,
...
`, Q);
  ...
  processMouseMove(A) {
    ...
    let M;
    const k = this.getViewportY(), e = Math.max(0, Math.floor(k));
    if (e > 0)
      if (C < e)
        M = t - e + C;
      else {
      ...
      M = t + C;
    this.linkDetector.getLinkAt(B, M).then((a) => {
      var c, J, N, U;
      if (a !== this.currentHoveredLink && ((J = (c = this.currentHoveredLink) == null ? void 0 : c.hover) == null || J.call(c, !1), this.currentHoveredLink = a, (N = a == null ? void 0 : a.hover) == null || N.call(a, !0), this.element && (this.element.style.cursor = a ? "pointer" : "text"), this.renderer))
        if (a) {
          const h = ((U = this.wasmTerm) == null ? void 0 : U.getScrollbackLength()) || 0, G = this.getViewportY(), r = Math.max(0, Math.floor(G)), T = a.range.start.y - h + r, m = a.range.end.y - h + r;
  ...
  processScrollbarDrag(A) {
    ...
    if (Q === 0)
      return;
    const B = this.canvas.getBoundingClientRect(), C = A.clientY - B.top - this.scrollbarDragStart, o = B.height - 4 * 2, w = this.rows, s = Q + w, t = Math.max(20, w / s * o), M = -C / (o - t), k = Math.round(M * Q), e = this.scrollbarDragStartViewportY + k;
...
class wA {
  ...
  proposeDimensions() {
    ...
    if (s === 0 || t === 0)
      return;
    const M = s - o - w - IA, k = t - I - D, e = Math.max(EA, Math.floor(M / B.width)), a = Math.max(CA, Math.floor(k / B.height));
    return { cols: e, rows: a };
  }
  /**
